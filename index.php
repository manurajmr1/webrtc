...
<!--                  <li><a href="#">Features</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
        <div class="col-lg-4">
          <a href="index.php"><img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
